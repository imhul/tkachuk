const translations = {
    english: {
        ...
        step_2023:
            "Working with Svelte and React and it's great. After an in-depth study, I can say with confidence that this is a top!",
        step_2024:
            "Delved into the world of MobX and mobx-state-tree.",
        step_2025:
            "Learned the basics of Next.js and started using it in my projects.",
        pending_step:
            "I believe in the victory of Ukraine! I believe in the Armed Forces! I plan to learn Python.",
    ...
    ukrainian: {
        ...
        step_2023:
            "Працюю зі Svelte та React і це прекрасно. Після поглибленого вивчення можу сказати впевнено, що це топ!",
        step_2024: "Поглибився у світ MobX та mobx-state-tree.",
        step_2025:
            "Вивчив основи Next.js і почав використовувати його у своїх проектах.",
        pending_step:
            "Вірю у перемогу України! Вірю у ЗСУ! Планую вивчити Python.",
        ...
        work_10:
            "Лендінгова сторінка компанії, зроблена за допомогою React 19 + GSAP",
        demo_status_desc:
